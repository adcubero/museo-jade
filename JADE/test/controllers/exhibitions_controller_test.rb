...
class ExhibitionsControllerTest < ActionController::TestCase
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post :create, exhibition: { description: @exhibition.description, item_id: @exhibition.item_id, miniDescription: @exhibition.miniDescription, name: @exhibition.name }
    end
  ...
  test "should update exhibition" do
    patch :update, id: @exhibition, exhibition: { description: @exhibition.description, item_id: @exhibition.item_id, miniDescription: @exhibition.miniDescription, name: @exhibition.name }
    assert_redirected_to exhibition_path(assigns(:exhibition))
  end
