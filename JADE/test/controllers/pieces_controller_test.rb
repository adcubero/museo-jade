...
class PiecesControllerTest < ActionController::TestCase
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post :create, piece: { description: @piece.description, item_id: @piece.item_id, name: @piece.name, room: @piece.room, showcase: @piece.showcase }
    end
  ...
  test "should update piece" do
    patch :update, id: @piece, piece: { description: @piece.description, item_id: @piece.item_id, name: @piece.name, room: @piece.room, showcase: @piece.showcase }
    assert_redirected_to piece_path(assigns(:piece))
  end
